...
class JobFormWidget extends HookConsumerWidget {
  const JobFormWidget({
    Key? key,
    this.job,
  }) : super(key: key);
    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            CustomAppBar(
              title: jobFormViewModel.isNewJob
                  ? 'Create job offer'
                  : 'Edit job offer',
              ...
              actions: [
                if (!jobFormViewModel.isNewJob)
                  CustomTextButton(
                    ...
                    radius: 25,
                    onPressed: () async {
                      if (jobFormViewModel.validateForm()) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            ...
                            backgroundColor: rareCrewColors.red,
              ...
              background: rareCrewColors.background,
            ),
            const YBox(20),
            CustomTextField(
            ...
            if (jobFormViewModel.isNewJob)
              CustomTextButton(
                ...
                onPressed: () async {
                  if (jobFormViewModel.validateForm()) {
                    jobFormViewModel.jobId = const Uuid().v4();
                    jobFormViewModel.createOrEditJob();
                    pop(context);
                  } else {
                    ScaffoldMessenger.of(context).showSnackBar(
